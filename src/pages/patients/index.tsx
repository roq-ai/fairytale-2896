...
export function PatientListPage(props: PatientListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getPatients({
        relations: ['practice', 'appointment.count', 'treatment_plan.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('appointment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('treatment_plan', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'treatment_plan',
          header: 'Treatment Plan',
          accessorKey: 'treatment_plan',
          cell: ({ row: { original: record } }: any) => record?._count?.treatment_plan,
        }
      : null,
