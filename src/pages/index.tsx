  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="FairyTale: Revolutionizing Dental Practices with Comprehensive Patient Management, Seamless Billing, Customized Treatment Planning, and Advanced Digital Imaging. Embrace HIPAA-compliant, Mobile-Ready Solutions for a Thriving Practice."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1616391182219-e080b4d1043a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkZW50YWwlMjBwcmFjdGljZXxlbnwwfHx8fDE2OTQyMTQ5ODB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`FairyTale: Revolutionizing Dental Practices with Comprehensive Patient Management, Seamless Billing, Customized Treatment Planning, and Advanced Digital Imaging. Embrace HIPAA-compliant, Mobile-Ready Solutions for a Thriving Practice.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Dentist Owner" type="dentist-owner" abilities={appConfig.ownerAbilities} />
