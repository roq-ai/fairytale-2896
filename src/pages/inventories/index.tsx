  ...
  const columns: ColumnType[] = [
    ...
    { id: 'reorder_level', header: 'reorder_level', accessorKey: 'reorder_level' },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.last_order_date ? format(parseISO(record?.last_order_date as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'next_order_date',
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.next_order_date ? format(parseISO(record?.next_order_date as unknown as string), 'dd-MM-yyyy') : '',
    },
