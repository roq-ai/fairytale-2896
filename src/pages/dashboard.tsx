...
import { getTreatmentPlans } from 'apiSdk/treatment-plans';
...
function DashboardPage() {
  ...
  const treatmentPlanStat = useSWR<PaginatedInterface<TreatmentPlanInterface>>(
    () => `/treatment-plans`,
    () => getTreatmentPlans({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    {
      ...
      result: treatmentPlanStat?.data?.totalCount,
      isLoading: treatmentPlanStat.isLoading,
